...
void moveOddItemsToBack(LinkedList *ll)
{
	...
	// Move all initial odd nodes (at the head) to the back until
	// the first even node is found or end is reached.
	...
	// Traverse the remaining list until reaching the end node.
	while (curr != end)
	{
		if (curr->item % 2 == 0)
		{
